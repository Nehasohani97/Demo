...
public class Practice {
	 public static void main(String[] args) 
	 {
			 ...
			 System.out.println(ls.equals(35)); // it will take the index value and print the element 
			 ...
			 // it will list is empty or not System.out.println(ls.isEmpty()); 
			 // print the value System.out.println(ls); 
			 Iterator<Integer> it = ls.iterator(); 
			 while (it.hasNext()) { System.out.println("it "+it.next()); }
			 // //size of list ls.size();
			 //update the value using index ls.set(0, 200); 
